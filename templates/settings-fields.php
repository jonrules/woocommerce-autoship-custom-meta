<table class="wc-autoship-custom-meta-settings-fields">
	...
	<tr>
		...
		<th><?php echo __( 'Title', 'wc-autoship-custom-meta' ); ?></th>
	...
	<?php for ( $row = 0; $row < 10; $row++ ): ?>
		...
		<?php $title = isset( $fields[ $row ]['title'] ) ? $fields[ $row ]['title'] : ''; ?>
		...
		<tr>
			...
			<td><input type="text" name="wc_autoship_custom_meta_fields[<?php echo $row; ?>][title]" class="wc-autoship-custom-meta-field-title" value="<?php echo esc_attr( $title ); ?>" placeholder="<?php echo esc_attr( $key ); ?>" /></td>
